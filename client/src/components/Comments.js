        ...
        {comments.map((comment) => (
          <div className="msg-container wrapper " key={JSON.stringify(comment.id)}>
            <div className="msg">
              ...
              <CommentPanelContainer postId={props.id} user={user} id={comment.id} likes={comment.likes} dislikes={comment.dislikes} title={props.title} owner={comment.username} url={props.url} date={comment.date} comments={props.comments} text={comment.text} />
