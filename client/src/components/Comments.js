...
const Comments = (props) => {
  ...
  useEffect(() => {
    ...
    if (commentsQuery.event === 'deleteCommentPanel' && commentsQuery.postId === props.id) {
      const commentsMap = [];
  ...
  }, [newCommentInput.length, user.name, props.id, props.postId, props.owner, commentsQuery, dispatch, comments]);
